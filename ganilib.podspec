...
Pod::Spec.new do |s|
  s.name             = 'ganilib'
  s.version          = '0.1.0'
  s.summary          = 'A short description of ganilib.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/apinrdw/ganilib'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'apinrdw' => 'apinrdw@gmail.com' }
  s.source           = { :git => 'https://github.com/apinrdw/ganilib.git', :tag => s.version.to_s }
